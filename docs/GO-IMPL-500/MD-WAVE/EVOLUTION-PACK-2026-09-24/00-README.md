...
| 24-UX | stopReason COMPLETE + CONFLICT scope + wrong-entity · `24-UX-STOPREASON-CONFLICT-WRONG-ENTITY-ממשק.md` | UX · ממשק | **IMPLEMENTED** (soft · Wave1 DONE=NO) |
...
- §24-UX COMPLETE stopReason + CONFLICT scope + wrong-entity helper · **IMPLEMENTED** (soft) · `?v=c1m3`
