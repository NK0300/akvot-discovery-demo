# MEGA · Core Acc P0 B23 Gate · דיוק · 2026-09-20
...
**Paired Acc-DISC Preview:** `dpl_CAVh2rDSNDFfjrGzw8EJWJNmPN4e` (B23)
...
| Smith POST+ctx warm | **PASS** | ui=`thin` · qid=`null` · faces=0 · no Q1701775 |
| Acc leakage | **PASS** | **0** |
...
| smith-warm | POST lookup +ctx | thin | null | 0 | 0 | 0 | PASS |
