...
**Machine copy:** `01-SOURCE-CAPABILITY-MATRIX.json`
...
| **candidate_*** | Missing, deferred, or only partially wired |

## LIVE today

| source | hostFamily | data types | identifier types | authority strength | coverage | freshness | cost | rate limit | failure modes | privacy/safety | independence semantics | status |
|--------|------------|------------|------------------|--------------------|----------|-----------|------|------------|---------------|----------------|------------------------|--------|
...
- VIAF = **code present + A2 Preview flag** · **absent from B0 DEFAULT_PROVIDERS** · frozen experimental — listed as live_experimental_preview_only, **not** B0-live.
...
| Lane | Providers |
|------|-----------|
| B0 | wikidata, wikipedia, openlibrary |
| A2 experimental Preview | + viaf (`DISCOVERY_ENABLE_VIAF=1`) |
