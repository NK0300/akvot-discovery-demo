# 01-EXPERIMENT-DEFINITION · EXP-A2-SAFE Typed Soft-Ref + Relationship Labels
...
## This wave Preview (A2-SAFE pack)

| Item | Value |
|------|-------|
| Preview dpl | `dpl_4Zxd9MnMs6WsTgSLrryyvGY3htpY` |
| URL | https://akvot-simple-demo-murf2gh8a-k-akvot.vercel.app |
| Delta vs 7Mmf enrich | `labelRelationship` on corroboration edges (`same-source` \| `same-reference` \| `same-entity` \| `related-entity` \| `possible-match` \| `unknown`) |
| Note | `same-entity` label means **typed soft-ref + title agree + multi-family attach** — still INFORMATION≠IDENTITY; Findings kept (attach_keep); **never** dossier collapse |
