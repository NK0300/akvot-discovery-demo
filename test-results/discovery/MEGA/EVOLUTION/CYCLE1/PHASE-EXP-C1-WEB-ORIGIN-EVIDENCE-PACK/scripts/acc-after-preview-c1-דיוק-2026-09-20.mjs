...
const RAW = join(PACK, 'raw/acc-after-דיוק');
mkdirSync(RAW, { recursive: true });
mkdirSync(join(PACK, '06-ACC'), { recursive: true });

const SCOPE = 'k-akvot';
const ROOT = '/workspace/akvot-quick-demo';
const TREAT = process.env.DPL_TREAT || 'dpl_BynXm5iQ17wLzYZ4aiHiMbGFJSkx';
...
writeFileSync(join(PACK, '06-ACC', 'ACC-AFTER-PREVIEW-דיוק-2026-09-20.json'), JSON.stringify(summary, null, 2));
