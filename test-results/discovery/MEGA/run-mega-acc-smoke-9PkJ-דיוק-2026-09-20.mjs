...
const RAW = join(__dirname, 'raw/acc-smoke-9PkJ');
const CORE_RAW = join(__dirname, 'raw/acc-smoke-9PkJ/core');
...
const OUT_DISC_JSON = join(__dirname, 'MEGA-ACC-SMOKE-9PkJ-דיוק-2026-09-20.json');
const OUT_DISC_MD = join(__dirname, 'MEGA-ACC-SMOKE-9PkJ-דיוק-2026-09-20.md');
const OUT_CORE_JSON = join(__dirname, 'MEGA-ACC-SMOKE-9PkJ-CORE-דיוק-2026-09-20.json');
const OUT_CORE_MD = join(__dirname, 'MEGA-ACC-SMOKE-9PkJ-CORE-דיוק-2026-09-20.md');
...
console.log(`[acc-smoke-9PkJ] start ${started}`);
console.log(`[acc-smoke-9PkJ] preview ${DISC_DPL} · alias ${ALIAS_DPL} · HOLD promote · SHORT Acc smoke`);
...
const discResult = {
  doc: 'MEGA-ACC-SMOKE-9PkJ-דיוק-2026-09-20',
  checked: started,
  finished,
...
const coreResult = {
  doc: 'MEGA-ACC-SMOKE-9PkJ-CORE-דיוק-2026-09-20',
  checked: started,
  finished,
  alias: ALIAS_BASE,
  dpl: ALIAS_DPL,
...
const discMd = `# MEGA · Acc SHORT smoke · CANONICAL Preview dpl_9PkJ · דיוק · 2026-09-20

**Checked:** ${started} → ${finished} (Asia/Jerusalem, UTC+3)  
**Promote:** **HOLD** (explicit · no promote · no Core rewrite)  
**Discovery Preview (CANONICAL · supersedes CAVh):** \`${DISC_BASE}\` · \`${DISC_DPL}\`  
...
const coreMd = `# MEGA · Core Acc P0 (paired with Acc smoke 9PkJ) · דיוק · 2026-09-20
...
**Paired Acc smoke Preview:** \`${DISC_DPL}\` (canonical 9PkJ)
...
Raw JSON: \`test-results/discovery/MEGA/raw/acc-smoke-9PkJ/core/{health,assaf,cohen,smith-nocache,smith-warm}.json\`
