...
gate('RB-12', 'ADV subset L1-L4 smoke PASS',
  advPass ? 'PASS' : 'FAIL',
  'MEGA/raw/release-9pkj/ADV-L*.json',
...
const report = {
  ...
  items,
  note: 'CANONICAL Preview dpl_9PkJ supersedes dpl_CAVh. Evidence: KV-PREVIEW-FIX-CHIEF. NO promote.',
};
...
**Purpose:** RELEASE formal on **CANONICAL Preview** dpl_9PkJ (supersedes dpl_CAVh). Evidence ref: KV-PREVIEW-FIX-CHIEF-2026-09-20.md. Prior CAVh NOT GREEN (RB-11/12). Real runs only.  
...
- \'raw/release-9pkj/\'
- Prior CAVh: \'QR-RELEASE-BATTERY-CAVh-${STAMP}.md\' (NOT GREEN · RB-11/12)
- Evidence: \'KV-PREVIEW-FIX-CHIEF-2026-09-20.md\'
