# Release Suite · בודק · dplHVGb-2026-09-15

- **TARGET Preview:** https://akvot-simple-demo-29yid8jo9-k-akvot.vercel.app
- **dpl:** `dpl_HVGb86Qrxe9Ztte3ESMCc7F3tnHk`
- **Access:** Vercel Deployment Protection — HTTP via `vercel env run` + `x-vercel-trusted-oidc-idp-token` preload (`test-results/vercel-oidc-fetch-preload.mjs`); health verified with `vercel curl` → HTTP 200 build=`dpl_HVGb86Qrxe9Ztte3ESMCc7F3tnHk`
- **Evidence:** post T-C6 Rappaport fix · no deploy/promote · no product/EXPECTED change
